...
class BayesText:
    ...
    def classify(self, filename):
        ...
        if results[0][1] == results[1][1]:
            #print("SAME PROBABILITY", results, filename)
            return 'female'
...
test('data/', 'genderWords.txt', 2)

#c1 = BayesText('sample/', 'genderWords.txt', 0, 2)
#c2 = BayesText('/Users/raz/twitterproject/sample/', 'genderWords.txt', 0, 0)
#c3 = BayesText('/Users/raz/twitterproject/sample/', 'genderWords.txt', 0, 0)
#r1 = c1.testCategory("%s%s/%i/" % ('sample/', 'female', 0), 'female')
#print(r1)
##r2 = c2.testCategory("%s%s/%i/" % ('sample/', 'female', 0), 'female')
##print(r2)
##r3 = c3.testCategory("%s%s/%i/" % ('sample/', 'female', 0), 'female')
##print(r3)
